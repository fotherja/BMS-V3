...
#define V_SOFT_HIGH_mV   4100   //3400   // start tapering charge above this
#define V_HARD_HIGH_mV   4200   //3500   // stop all charging at/above this
#define V_CLEAR_HIGH_mV  (V_HARD_HIGH_mV - 50)  // hysteresis to re-enable charge

#define V_SOFT_LOW_mV    3500   //2900   // start tapering discharge below this
#define V_HARD_LOW_mV    3350   //2750   // stop discharging at/below this
#define V_CLEAR_LOW_mV   (V_HARD_LOW_mV + 50)   // hysteresis to re-enable discharge

#define CVL_BASE_PC_mV   4150   //3450   // base per-cell CVL target in normal operation
#define CVL_MIN_PC_mV    3900   //3300   // don’t reduce CVL below this (soft floor)
#define CVL_HEADROOM_mV  75     // keep CVL at least pack+HEADROOM so charger doesn’t stall

#define MAX_CCL_mA       80000  // max charge current your pack allows (80 A example)
#define MAX_DCL_mA       150000 // max discharge current (150 A example)
...
static constexpr uint16_t CELL_ABS_MAX_mV = 4850;  // absolute ceiling (3.65 V + margin)

static constexpr uint32_t PACK_ABS_MIN_mV = 40000;
static constexpr uint32_t PACK_ABS_MAX_mV = 80000;
